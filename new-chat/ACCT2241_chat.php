...
$statement = $conn->prepare("SELECT DISTINCT from_user_id,full_name,image FROM (SELECT * FROM chat_message10 JOIN tbl_user ON chat_message10.from_user_id=tbl_user.id) as D");
$statement->execute(array());
$result = $statement->fetchAll(PDO::FETCH_ASSOC);
$okki="private_chat_fetch.php";
?>
<!DOCTYPE html>
        	...
        	<div class="panel panel-info">
				...
				<div class="panel-footer">
					<div class="input-group">
						...
						<span class="input-group-btn">
							<button class="btn btn-info" type="button" name="send_group_chat" id="send_group_chat" style="left:10px;" >SEND</button>
						</span>
					</div>
				</div>
			</div>
                    ...
                    ?>
						<li class="media">
							...
							<div class="media-body">
								...
								<div class="media">
									<a class="pull-left" href="profile.php?id=<?php echo $row['from_user_id']; ?>">
										<img class="media-object img-circle" style="max-height:40px;" src="<?php echo $row['image']; ?>" />
									</a>
									<div class="media-body" >
										<a href="profile.php?id=<?php echo $row['from_user_id']; ?>"><h5><?php echo $row['full_name']; ?></h5></a>
									</div>
								</div>
