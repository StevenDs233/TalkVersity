...
$statement = $conn->prepare("SELECT DISTINCT from_user_id,full_name,image FROM (SELECT * FROM chat_message JOIN tbl_user ON chat_message.from_user_id=tbl_user.id) as D");
