...
$statement = $conn->prepare("SELECT DISTINCT from_user_id,full_name,image FROM (SELECT * FROM chat_message9 JOIN tbl_user ON chat_message9.from_user_id=tbl_user.id) as D");
