...
$statement = $conn->prepare("SELECT * FROM friend_request JOIN tbl_user ON friend_request.request_from=tbl_user.id WHERE request_to=?");
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading c-list">
                                <span class="title">You have <?php echo $count; ?> friend request</span>
                            </div>
                            ...
                            <ul class="list-group" id="contact-list">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <div class="col-xs-12 col-sm-4">
                                        <br/><br/>
                                        <a href="accept_friend_request.php?friend=<?php echo $row['id']; ?>" class="btn btn-lg btn-success">ACCEPT</a>
                                    </div>
